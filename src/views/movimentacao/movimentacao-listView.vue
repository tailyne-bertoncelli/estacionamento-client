<template>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-start m-0">Movimentação</h1>
            </div>
            ...
            <tbody class="table-group-divider">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="bi bi-text-left me-2"
