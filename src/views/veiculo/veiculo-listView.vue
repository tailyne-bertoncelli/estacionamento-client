<template>
    <div class="container mt-5">
        <div class="row">
            ...
            <router-link to="/veiculo/formulario" class="col d-flex align-items-center justify-content-end" style="text-decoration: none;">
        ...
        <table class="table table-striped mt-4 col-12">
            ...
            <tbody class="table-group-divider">
                <tr v-for="item in veiculoList" :key="item.id">
                    ...
                    <td>{{ item.ano }}</td>
                    <td>
                        <router-link :to="{name: 'veiculo-formulario-editar-view', query: {id: item.id, form: 'editar'} }">
                    ...
                    <td>
                        <router-link :to="{name: 'veiculo-formulario-excluir-view', query: {id: item.id, form: 'excluir'} }">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <td>
                        <router-link :to="{name: 'veiculo-formulario-ver-view', query: {id: item.id, form: 'ver'} }">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
